...
<ul style="list-style-type: none">
  <li style="margin-left: -20px"><span style="color:#b30000; font-size: 14px; padding-left: 15px">&#x27A2;</span> Examples of definitions in footnote (from <em><a href="http://ane-research-humanities.science/docs/CyberResearch-vol1" target="_blank">CyberResearch on the Ancient Near East and Neighboring Regions)</a></em>:
